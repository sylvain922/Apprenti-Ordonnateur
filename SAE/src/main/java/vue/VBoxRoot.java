...
public class VBoxRoot extends VBox implements ConstanteCanvas {
    private static final int COORD_MIN = -15;
    private static final int COORD_MAX = 15;
    ...
    public VBoxRoot () {
        ...
        canvasCarte.setOnMouseClicked(event -> {
            ...
            gc.setFill(Color.GREY); // La couleur de remplissage pour le carré
    ...
    public void effacerMilieuCase(){
        graphicsContext2D.setFill(Color.WHITE); // Utilisez la couleur de fond de votre grille
